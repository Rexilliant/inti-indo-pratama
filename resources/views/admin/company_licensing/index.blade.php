                ...
                <table class="w-full text-sm text-left text-gray-900 whitespace-nowrap">
                    <thead class="bg-[#5aba6f]/70 text-gray-900">
                        <tr class="[&>th]:border-b [&>th]:border-gray-500">
                            ...
                            <th scope="col" class="px-6 py-4 font-extrabold text-left">Nama Perizinan</th>
                    ...
                    <tbody class="bg-gray-200 divide-y divide-gray-500">
                        @php
                            ...
                            $faqs = [
                                [
                                    'tanggal' => '07/06/2026',
                                    'nama_perizinan' => 'Nomor Induk Berusaha',
                                ],
                                [
                                    'tanggal' => '05/06/2026',
                                    'nama_perizinan' => 'Izin Edar',
                                ],
                                [
                                    'tanggal' => '01/06/2026',
                                    'nama_perizinan' => 'Pemenuhan Standar Mutu (SNI)',
                                ],
                            ];
                        @endphp
                        ...
                        @foreach ($faqs as $faq)
                            <tr class="[&>td]:border-b [&>td]:border-gray-400 hover:bg-gray-100">
                                <td class="px-6 py-4">{{ $faq['tanggal'] }}</td>
                                <td class="px-6 py-4 font-medium whitespace-normal min-w-[250px]">
                                    {{ $faq['nama_perizinan'] }}</td>
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('admin.licensing.edit') }}"
