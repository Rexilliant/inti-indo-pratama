...
@section('content')
    ...
    <section class="mb-6">
        <div class="text-lg sm:text-2xl font-bold">
            ...
            <span class="text-[#2D37CC]">Edit FAQs</span>
        </div>
    </section>
    ...
    <form action="#" method="POST">
        ...
        <div class="bg-gray-200/80 p-4 sm:p-5 rounded-xl shadow-sm border border-gray-300 mb-5">
            ...
            <input type="text"
                ...
                placeholder="Masukkan pertanyaan..." value="Apa yang membuat BHOS Teknologi berbeda?">
        </div>
        ...
        <div class="bg-gray-200/80 p-4 sm:p-5 rounded-xl shadow-sm border border-gray-300 mb-5">
            ...
            <textarea rows="8"
                ...
                placeholder="Masukkan jawaban...">PT Grace Indo Pratama merupakan perusahaan yang bergerak di bidang pupuk kimia dengan fokus pada pengembangan teknologi nano. Melalui inovasi yang berkelanjutan, kami menghadirkan produk yang dirancang untuk meningkatkan efisiensi penyerapan unsur hara dan mendukung produktivitas pertanian secara optimal.

Kami hadir untuk menjadi mitra terpercaya dalam menghadirkan solusi nutrisi tanaman yang modern, efektif, dan relevan dengan kebutuhan pertanian masa kini.</textarea>
        </div>
