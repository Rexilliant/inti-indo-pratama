    ...
    <div class="w-full bg-[#ECFDF5] py-10 lg:py-20 overflow-hidden">
        <section class="mx-auto max-w-screen-xl px-0 lg:px-8">
            ...
            [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                ...
                {{-- Looping Data Licensing dari Database --}}
                @foreach ($licenses as $license)
                    <div
                        ...
                        <div class="mt-auto grid grid-cols-2 gap-3">
                            <a href="{{ $license->getFirstMediaUrl('licenses') }}" target="_blank"
                                class="flex items-center justify-center gap-1.5 px-2 sm:px-4 py-2.5 text-xs sm:text-sm font-bold text-[#047857] bg-white border border-[#047857] rounded-xl hover:bg-green-50 transition-colors lg:whitespace-nowrap">
